...
const (
	ProductionRecordService_GetProductionRecordById_FullMethodName = "/proto.ProductionRecordService/GetProductionRecordById"
	ProductionRecordService_GetProductionRecords_FullMethodName    = "/proto.ProductionRecordService/GetProductionRecords"
	ProductionRecordService_CreateProductionRecord_FullMethodName  = "/proto.ProductionRecordService/CreateProductionRecord"
	ProductionRecordService_UpdateProductionRecord_FullMethodName  = "/proto.ProductionRecordService/UpdateProductionRecord"
	ProductionRecordService_DeleteProductionRecord_FullMethodName  = "/proto.ProductionRecordService/DeleteProductionRecord"
)
...
type ProductionRecordServiceClient interface {
	GetProductionRecordById(ctx context.Context, in *GetProductionRecordByIdRequest, opts ...grpc.CallOption) (*ProductionRecord, error)
	...
	CreateProductionRecord(ctx context.Context, in *CreateProductionRecordRequest, opts ...grpc.CallOption) (*ProductionRecord, error)
	UpdateProductionRecord(ctx context.Context, in *UpdateProductionRecordRequest, opts ...grpc.CallOption) (*ProductionRecord, error)
...
func (c *productionRecordServiceClient) GetProductionRecordById(ctx context.Context, in *GetProductionRecordByIdRequest, opts ...grpc.CallOption) (*ProductionRecord, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductionRecord)
...
func (c *productionRecordServiceClient) CreateProductionRecord(ctx context.Context, in *CreateProductionRecordRequest, opts ...grpc.CallOption) (*ProductionRecord, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductionRecord)
...
func (c *productionRecordServiceClient) UpdateProductionRecord(ctx context.Context, in *UpdateProductionRecordRequest, opts ...grpc.CallOption) (*ProductionRecord, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductionRecord)
...
type ProductionRecordServiceServer interface {
	GetProductionRecordById(context.Context, *GetProductionRecordByIdRequest) (*ProductionRecord, error)
	GetProductionRecords(context.Context, *GetProductionRecordsRequest) (*GetProductionRecordsResponse, error)
	CreateProductionRecord(context.Context, *CreateProductionRecordRequest) (*ProductionRecord, error)
	UpdateProductionRecord(context.Context, *UpdateProductionRecordRequest) (*ProductionRecord, error)
...
func (UnimplementedProductionRecordServiceServer) GetProductionRecordById(context.Context, *GetProductionRecordByIdRequest) (*ProductionRecord, error) {
...
func (UnimplementedProductionRecordServiceServer) CreateProductionRecord(context.Context, *CreateProductionRecordRequest) (*ProductionRecord, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateProductionRecord not implemented")
}
func (UnimplementedProductionRecordServiceServer) UpdateProductionRecord(context.Context, *UpdateProductionRecordRequest) (*ProductionRecord, error) {
...
var ProductionRecordService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.ProductionRecordService",
	...
	Metadata: "production_record.proto",
}
