...
func (x *BreedingRecord) Reset() {
	*x = BreedingRecord{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[0]
...
func (*BreedingRecord) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateBreedingRecordRequest) Reset() {
	*x = CreateBreedingRecordRequest{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBreedingRecordRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{1}
}
...
func (x *CreateBreedingRecordResponse) Reset() {
	*x = CreateBreedingRecordResponse{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBreedingRecordResponse) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetBreedingRecordRequest) Reset() {
	*x = GetBreedingRecordRequest{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetBreedingRecordRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetBreedingRecordResponse) Reset() {
	*x = GetBreedingRecordResponse{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetBreedingRecordResponse) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{4}
}
...
func (x *UpdateBreedingRecordRequest) Reset() {
	*x = UpdateBreedingRecordRequest{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateBreedingRecordRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{5}
}
...
func (x *UpdateBreedingRecordResponse) Reset() {
	*x = UpdateBreedingRecordResponse{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateBreedingRecordResponse) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{6}
}
...
func (x *DeleteBreedingRecordRequest) Reset() {
	*x = DeleteBreedingRecordRequest{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteBreedingRecordRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{7}
}
...
func (x *DeleteBreedingRecordResponse) Reset() {
	*x = DeleteBreedingRecordResponse{}
	mi := &file_proto_v1_livestock_breeding_record_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteBreedingRecordResponse) Descriptor() ([]byte, []int) {
	return file_proto_v1_livestock_breeding_record_proto_rawDescGZIP(), []int{8}
}

var File_proto_v1_livestock_breeding_record_proto protoreflect.FileDescriptor

var file_proto_v1_livestock_breeding_record_proto_rawDesc = []byte{
	0x0a, 0x28, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x6c, 0x69, 0x76, 0x65, 0x73,
	0x74, 0x6f, 0x63, 0x6b, 0x2f, 0x62, 0x72, 0x65, 0x65, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x72, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x22, 0xec,
	...
	0x6c, 0x69, 0x76, 0x65, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x42, 0x72, 0x65, 0x65, 0x64, 0x69,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x76, 0x31,
	0x2e, 0x6c, 0x69, 0x76, 0x65, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x42, 0x72, 0x65, 0x65, 0x64,
	...
	0x72, 0x64, 0x12, 0x2c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x6c, 0x69,
	0x76, 0x65, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x47, 0x65, 0x74, 0x42, 0x72, 0x65, 0x65, 0x64,
	0x69, 0x6e, 0x67, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x2d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x6c, 0x69, 0x76, 0x65,
	0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x47, 0x65, 0x74, 0x42, 0x72, 0x65, 0x65, 0x64, 0x69, 0x6e,
	...
	0x76, 0x65, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42, 0x72,
	...
	0x69, 0x76, 0x65, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42,
...
var (
	file_proto_v1_livestock_breeding_record_proto_rawDescOnce sync.Once
	file_proto_v1_livestock_breeding_record_proto_rawDescData = file_proto_v1_livestock_breeding_record_proto_rawDesc
)

func file_proto_v1_livestock_breeding_record_proto_rawDescGZIP() []byte {
	file_proto_v1_livestock_breeding_record_proto_rawDescOnce.Do(func() {
		file_proto_v1_livestock_breeding_record_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_v1_livestock_breeding_record_proto_rawDescData)
	})
	return file_proto_v1_livestock_breeding_record_proto_rawDescData
}

var file_proto_v1_livestock_breeding_record_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_proto_v1_livestock_breeding_record_proto_goTypes = []any{
...
var file_proto_v1_livestock_breeding_record_proto_depIdxs = []int32{
...
func init() { file_proto_v1_livestock_breeding_record_proto_init() }
func file_proto_v1_livestock_breeding_record_proto_init() {
	if File_proto_v1_livestock_breeding_record_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_v1_livestock_breeding_record_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_v1_livestock_breeding_record_proto_goTypes,
		DependencyIndexes: file_proto_v1_livestock_breeding_record_proto_depIdxs,
		MessageInfos:      file_proto_v1_livestock_breeding_record_proto_msgTypes,
	}.Build()
	File_proto_v1_livestock_breeding_record_proto = out.File
	file_proto_v1_livestock_breeding_record_proto_rawDesc = nil
	file_proto_v1_livestock_breeding_record_proto_goTypes = nil
	file_proto_v1_livestock_breeding_record_proto_depIdxs = nil
}
